...
//
//    /**
//     * Test case for sObjectRowsByExternalId method.
//     */
//    @Test(enabled = true, description = "salesforcerest {sObjectRowsByExternalId} integration test.")
//    public void sObjectRowsByExternalId() throws IOException, JSONException {
//
//        String methodName = "sObjectRowsByExternalId";
//        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap, "sObjectRowsByExternalId.json");
//        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/services/data/"+ connectorProperties.getProperty("apiVersion")+"/sobjects/"+connectorProperties.getProperty("rowField")+"/"+connectorProperties.getProperty("rowValue");
//        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
//        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
//
//    }
...
//
//    /**
//     * Test case for searchSuggestedRecords method.
//     */
//    @Test(enabled = true, description = "salesforcerest {searchSuggestedRecords} integration test.")
//    public void searchSuggestedRecords() throws IOException, JSONException {
//
...
//        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/services/data/"+ connectorProperties.getProperty("apiVersion")+"/search/layout?q="+connectorProperties.getProperty("searchString")+"&sobject="+connectorProperties.getProperty("sobject");
//        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
//        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
//
//    }
